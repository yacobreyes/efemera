  ...
  const bodyHtml = cards.map((card, idx) => {
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#faf9f6;border-top:1px solid #e8e3d8;border-bottom:1px solid #e8e3d8;margin:0;">
      ...
      <tr><td style="padding:24px 32px 32px;text-align:center;">
        ...
        <p style="font-family:${FONT};font-size:10px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:${TEXT_MUTED};margin:0 0 20px;text-align:center;">A Micro-Memoir${card.byline ? ` by ${esc(card.byline)}` : ""}</p>
