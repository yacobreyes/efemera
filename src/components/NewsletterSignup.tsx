...
export default function NewsletterSignup() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 360, textAlign: "center" }}>
      <p style={{ fontFamily: "var(--font-subhead)", fontSize: "0.78rem", color: "white", margin: "0 0 0.6rem", letterSpacing: "0.04em", opacity: 0.95 }}>
        Get new stories in your inbox.
      </p>
      {status === "done" ? (
        <p style={{ fontFamily: "var(--font-subhead)", fontSize: "0.8rem", color: "white", margin: 0, fontWeight: 600 }}>{message}</p>
      ) : (
      ...
      {status === "error" && <p style={{ fontFamily: "var(--font-subhead)", fontSize: "0.72rem", color: "white", margin: "0.5rem 0 0", opacity: 0.9 }}>{message}</p>}
    </div>
  );
}
