  ...
  return (
    <div className="about-page">
      <style>{`
        ...
        .about-body { font-family: var(--font-cormorant), Georgia, serif; font-size: 22px; line-height: 1.62; color: #211c17; }
        .about-body p { margin: 1.2rem 0 0; }
        .about-body p:first-child { margin-top: 0; }
        .about-body a { color: #8e0d0d; text-decoration: underline; }
        .about-empty { font-family: var(--font-cormorant), Georgia, serif; font-size: 22px; font-style: italic; color: #6f655b; }
            ...
            <PortableText
              ...
              components={{
                block: {
                  ...
                  h2: ({ children }) => <h2 style={{ fontFamily: 'var(--font-cormorant), Georgia, serif', fontWeight: 700, fontSize: "1.9rem", margin: "2rem 0 0", letterSpacing: "-.02em" }}>{children}</h2>,
                  h3: ({ children }) => <h3 style={{ fontFamily: 'var(--font-cormorant), Georgia, serif', fontWeight: 700, fontSize: "1.5rem", margin: "1.7rem 0 0" }}>{children}</h3>,
