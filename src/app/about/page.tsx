  ...
  return (
    <div className="about-page">
      <style>{`
        ...
        .about-main { flex: 1; width: 100%; max-width: 680px; margin: 0 auto; padding: 72px 24px 64px; box-sizing: border-box; }
        .about-kicker {
          font-family: Inter, system-ui, sans-serif;
          font-size: 12px; font-weight: 800; letter-spacing: .22em; text-transform: uppercase;
          color: #8e0d0d; margin-bottom: 16px;
        }
        .about-title {
          font-family: "Cormorant Garamond", Georgia, serif;
          font-size: clamp(46px, 8vw, 78px); line-height: .98; letter-spacing: -.03em;
          margin: 0 0 32px; padding-bottom: 30px; border-bottom: 1px solid #cfc3b3;
        }
        ...
        @media (max-width: 600px) { .about-main { padding: 44px 22px 48px; } }
      `}</style>
      <MagHeader />
